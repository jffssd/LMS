...
class M_equipes extends CI_Model {
	...
	public function get_jogador_by_equipe($id = null){
		...
		if ($id) {
			$this->db->select('jogador.nick, jogador.at_trab, jogador.at_ment, jogador.at_consist, jogador.at_mec, jogador.at_vis, jogador.foto, jogador.funcao_id, jogador.pais_id');
