			...
			<div style="background-color: #262b33; color #eeeeee; padding-top:16px; padding-left:0px; padding-right:0px; border-radius: 10px;">
				<table class="table table-bordered table-sm table-hover" id="dataTable" width="100%" cellspacing="0" style="background-color:white; border: 1px solid #262b33;">
					...
					<tbody>
						...
						<tr>
							<td align="center"><h5><span class="badge badge-dark"><?php echo date("m", strtotime($t_j->data_transacao));?></span><span class="badge badge-secondary"><?php echo date("Y", strtotime($t_j->data_transacao));?></span></h5></td>
		...
		<div class="table-responsive" style="padding-top:10px; padding-left:0px; padding-right:0px;">
			<div style="background-color: #262b33; color #eeeeee; padding-top:16px; padding-left:0px; padding-right:0px; border-radius: 10px;">
				<table class="table table-bordered table-sm table-hover" id="dataTable" width="100%" cellspacing="0" style="background-color:white; border: 1px solid #262b33;">
					...
					<tbody>
						<?php foreach($transf_profissional -> result() as $t_p){ ?>
						<tr>
							<td align="center"><h5><span class="badge badge-dark"><?php echo date("m", strtotime($t_p->data_transacao));?></span><span class="badge badge-secondary"><?php echo date("Y", strtotime($t_p->data_transacao));?></span></h5></td>
							<td align="center"><img src="<?php echo site_url().'assets/img/logo-equipes/'.$t_p->equipe_logo;?>" alt="<?php echo $t_p->equipe_logo;?>" width="40" height="40"> </td>
							...
							<td><img src="<?php echo site_url().'assets/img/profiles/thumb/'.$t_p->foto;?>" width="40" height="40" style="border-radius:7px;"> <span style="font-size: 16px;"><?php echo $t_p->nick;?></span></td>
							<td><?php echo $t_p->cargo_descricao;?></td>	
							<td><img src="<?php echo site_url().'assets/img/bandeiras/'.$t_p->pais_flag;?>.png" width="40" height="25"></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
