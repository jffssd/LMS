...
<div class="left main-sidebar">
	<div class="sidebar-inner leftscroll">
        <div id="sidebar-menu">
            <ul>
                <li class="submenu">
                    <a <?php echo $item=='inicio' ? 'class="active"' : ''; ?> href="<?php echo base_url('inicio');?>"><i class="fa fa-fw fa-bars"></i><span> Painel Principal </span> </a>
                </li>

                <li class="submenu">
                    <a <?php echo $item=='perfil' ? 'class="active"' : ''; ?> href="<?php echo base_url('perfil');?>"><i class="fa fa-fw fa-user-circle"></i><span> Perfil </span> </a>
                </li>

                <li class="submenu">
                    <a <?php echo $item=='mensagens' ? 'class="active"' : ''; ?> href="<?php echo base_url('mensagens');?>"><i class="fa fa-fw fa-envelope-o"></i><span> Mensagens </span> <span class="label radius-circle bg-success float-right">2</span></a>
                </li>
                
                <li class="submenu">
                    <a href="<?php echo base_url('bolao/inicio');?>" class="bolao-link"><i class="fa fa-fw fa-soccer-ball-o"></i><span> Bolão </span> </a>
                </li>

                <li class="submenu">
                    <a href="<?php echo base_url('carreira/inicio');?>" class="carreira-link"><i class="fa fa-fw fa-star"></i><span> Carreira </span> </a>
                </li>
