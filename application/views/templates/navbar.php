...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="index.html" class="logo"><img alt="Logo" src="<?php echo base_url('assets/images/logo.png');?>" /> <span>Admin</span></a>
        </div>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notif">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg">
                                <!-- item-->
                                <div class="dropdown-item noti-title">
                                    <h5><small><span class="label label-danger badge badge-danger pull-xs-right">12</span>Contact Messages</small></h5>
                                </div>
