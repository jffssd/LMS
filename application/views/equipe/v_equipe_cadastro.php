			...
			<div class="form-row">
    			<div class="form-group col-md-9">
					...
					<div class="input-group mb-2">
						...
						<input type="text" class="form-control" name="nome" id="nome" placeholder="Nome" value="" autofocus="true" required>
					</div>
    			...
    			<div class="form-group col-md-3">
					...
					<div class="input-group mb-2">
						...
						<input type="text" class="form-control" name="sigla" id="sigla" placeholder="Sigla" value="" autofocus="true" required>
					</div>
				</div>
 			</div>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
					...
					<div class="input-group mb-2">
						...
						<input type="text" name="site" id="site" class="form-control" value="" placeholder="Site" autofocus="true" />
					</div>
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
					...
					<div class="input-group mb-2">
						...
						<input type="text" name="social_fb" id="social_fb" class="form-control" value="" placeholder="Facebook" autofocus="true" />
					</div>
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
					...
					<div class="input-group mb-2">
						...
						<input type="text" name="social_tw" id="social_tw" class="form-control" value="" placeholder="Twitter" autofocus="true" />
					</div>
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
					...
					<div class="input-group mb-2">
						...
						<input type="text" name="social_in" id="social_in" class="form-control" value="" placeholder="Instagram" autofocus="true" />
					</div>
				</div>
			</div>
            ...
            <div class="form-row">
				<div class="form-group col-md-12">
					...
					<div class="input-group mb-2">
						...
						<input type="text" name="cor_primaria" id="cor_primaria" class="form-control" value="" placeholder="Cor Primária" autofocus="true" />
					</div>
				</div>
			</div>
            ...
            <div class="form-row">
				<div class="form-group col-md-12">
					...
					<div class="input-group mb-2">
						...
						<input type="text" name="cor_secundaria" id="cor_secundaria" class="form-control" value="" placeholder="Cor Secundária" autofocus="true" />
					</div>
				</div>
			</div>
