...
<h4><?php echo strtoupper($sigla);?></h4>

<img src="<?php echo site_url();?>assets/img/logo-equipes/<?php echo $logo;?>" width="100" height="100">

<img src="<?php echo site_url();?>assets/img/bandeiras/<?php echo $pais;?>.png" width="30" height="20">

<img src="<?php echo site_url();?>assets/img/logo-ligas/<?php echo $regiao;?>.png" width="120" height="25">

<ul>
	<li><a href="#facebook"><img src="<?php echo site_url();?>assets/img/social/facebook.png" width="40" height="40"></a></li>
	<li><a href="#twitter"><img src="<?php echo site_url();?>assets/img/social/twitter.png" width="40" height="40"></a></li>
	<li><a href="#instagram"><img src="<?php echo site_url();?>assets/img/social/instagram.png" width="40" height="40"></a></li>
</ul>

<h3>Nota: <?php echo substr($valor,0,3);?></h3>
...
<img class="photo-team-coach" src="<?php echo site_url();?>assets/img/profiles/default.jpg" width="106" height="106">
<h5 class="card-team-coach-font">Nome "<span class="card-coach-nick">Nick</span>" Sobrenome</h5>
