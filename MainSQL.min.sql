...
-- -----------------------------------------------------
-- Table `lmdb`.`cargos_profissionais`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `lmdb`.`cargos_profissionais` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `descricao` VARCHAR(45) NOT NULL,
  `valor` INT DEFAULT 0,
  PRIMARY KEY (`id`))
...
CREATE TABLE IF NOT EXISTS `lmdb`.`transferencia_profissional` (
  ...
  CONSTRAINT `fk_transferencia_profissional_cargo_profissional_id`
    ...
    REFERENCES `lmdb`.`cargos_profissionais` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
('CNB e-Sports Club', 'CNB', 1, 'A', 28, 1, 'cnb-esports-logo.png', '#0083db', '#ffffff', 7.2),
('Keyd Stars', 'VFK', 1, 'A', 28, 1, 'keyd-stars-logo.png', '#828282', '#f4f142', 7.2),
('Operation Kino', 'OPK', 1, 'A', 28, 1, 'operation-kino-logo.png', '#ffffff', '#000000', 7.2),
('ProGaming e-Sports', 'PRG', 1, 'A', 28, 1, 'progaming-esports-logo.png', '#0083db', '#000000', 7.2),
('Team One', 'TONE', 1, 'A', 28, 1, 'team-one-logo.png', '#828282', '#f4f142', 7.2),
('Iron Hawks', 'IHW', 1, 'A', 28, 1, 'iron-hawks-logo.png', '#b20101', '#000000', 7.2),
('Merciless Gaming', 'MLG', 1, 'I', 28, 1, 'merciless-gaming-logo.png', '#0083db','#ffffff', 7.2),
('Ilha da Macacada', 'IDM', 1, 'A', 28, 1, 'ilha-da-macacada-logo.png', '#f4f142', '#000000', 7.2),
('CNB Blue', 'CNB-B', 1, 'I', 28, 1, 'cnb-esports-logo.png', '#0083db', '#ffffff', 7.2),
('CNB Trinity White', 'CNB-TW', 1, 'A', 28, 1, 'cnb-esports-logo.png', '#0083db', '#ffffff', 7.2),
('Flamengo E-sports', 'FLA', 1, 'A', 28, 1, 'flamengo-esports-logo.png', '#b20101', '#000000', 7.2),
('INTZ E-sports', 'ITZ', 1, 'A', 28, 1, 'intz-logo.png', '#ffffff', '#000000', 7.2),
('Kabum E-sports', 'KBM', 1, 'A', 28, 1, 'kabum-esports-logo.png', '#d1461a', '#000000', 7.2),
('T-SHOW', 'TSW', 1, 'A', 28, 1, 't-show-esports-logo.png', '#828282', '#f4f142', 7.2),
('Submarino Stars', 'SMS', 1, 'A', 28, 1, 'submarino-stars-logo.png', '#828282', '#f4f142', 7.2);
...
('2017/01/06', 40, 16, 1, 'F', 1),
('2017/01/06', 126, 16, 1, 'F', 1),
('2017/01/06', 103, 16, 1, 'F', 1),
('2017/01/06', 102, 16, 1, 'F', 1),
('2017/01/06', 44, 16, 1, 'F', 1),
('2017/01/13', 127, 11, 2, 'F', 1),
('2017/01/13', 128, 11, 2, 'F', 1),
('2017/01/13', 26, 11, 2, 'F', 1),
('2017/01/13', 129, 11, 2, 'F', 1),
('2017/01/31', 97, 17, 1, 'F', 1),
('2017/01/31', 62, 17, 1, 'F', 1),
('2017/01/31', 96, 17, 1, 'F', 1),
('2017/01/31', 95, 17, 1, 'F', 1),
('2017/03/03', 43, 16, 1, 'F', 1),
('2017/03/06', 34, 15, 1, 'F', 1),
('2017/03/06', 103, 16, 2, 'F', 1),
('2017/04/11', 102, 16, 2, 'F', 1),
('2017/04/20', 103, 4, 1, 'F', 1),
('2017/04/25', 72, 6, 2, 'F', 1),
('2017/04/26', 42, 7, 1, 'F', 1),
('2017/04/26', 72, 7, 1, 'F', 1),
('2017/04/26', 42, 6, 2, 'F', 1),
('2017/04/28', 87, 8, 1, 'F', 1),
('2017/04/28', 84, 8, 1, 'F', 1),
('2017/04/28', 83, 8, 1, 'F', 1),
('2017/04/28', 38, 8, 1, 'F', 1),
('2017/04/28', 86, 8, 1, 'F', 1),
('2017/05/05', 126, 16, 2, 'F', 1),
('2017/05/09', 21, 1, 2, 'F', 1),
('2017/05/11', 85, 2, 2, 'F', 1),
('2017/05/12', 85, 8, 1, 'F', 1),
('2017/05/15', 130, 2, 1, 'F', 1),
('2017/05/16', 28, 6, 2, 'F', 1),
('2017/05/16', 126, 17, 1, 'F', 1),
('2017/05/17', 116, 17, 1, 'F', 1),
('2017/05/18', 115, 17, 1, 'F', 1),
('2017/05/22', 101, 1, 1, 'F', 1),
('2017/05/22', 50, 5, 1, 'F', 1),
('2017/05/22', 53, 5, 1, 'F', 1),
('2017/05/22', 131, 5, 1, 'F', 1),
('2017/05/22', 7, 4, 1, 'F', 1),
('2017/05/24', 8, 4, 3, 'F', 1),
('2017/05/24', 8, 4, 4, 'F', 1),
('2017/05/24', 46, 16, 1, 'F', 1),
('2017/05/24', 45, 16, 1, 'F', 1),
('2017/05/24', 8, 6, 4, 'F', 1),
('2017/05/30', 26, 9, 1, 'F', 1),
('2017/06/22', 11, 4, 1, 'F', 1),
('2017/08/09', 36, 5, 2, 'F', 1),
('2017/08/10', 131, 5, 2, 'F', 1),
('2017/08/15', 11, 4, 2, 'F', 1),
('2017/09/05', 129, 10, 2, 'F', 1),
('2017/09/07', 114, 9, 2, 'F', 1),
('2017/09/20', 42, 7, 2, 'F', 1),
('2017/09/21', 70, 4, 2, 'F', 1),
('2017/09/21', 70, 7, 1, 'F', 1),
('2017/09/23', 74, 7, 1, 'F', 1),
('2017/09/23', 74, 6, 2, 'F', 1),
('2017/09/24', 135, 9, 2, 'F', 1),
('2017/09/28', 130, 2, 2, 'F', 1),
('2017/10/05', 41, 10, 2, 'F', 1),
('2017/10/10', 104, 1, 2, 'F', 1),
('2017/10/10', 39, 15, 2, 'F', 1),
('2017/10/10', 54, 15, 2, 'F', 1),
('2017/10/11', 47, 6, 2, 'F', 1),
('2017/10/12', 60, 4, 3, 'F', 1),
('2017/10/12', 62, 6, 1, 'F', 1),
('2017/10/12', 59, 6, 1, 'F', 1),
('2017/10/12', 60, 6, 4, 'F', 1),
('2017/10/12', 62, 17, 2, 'F', 1),
('2017/10/16', 9, 1, 2, 'F', 1),
('2017/10/16', 63, 5, 2, 'F', 1),
('2017/10/16', 64, 4, 2, 'F', 1),
('2017/10/18', 52, 2, 2, 'F', 1),
('2017/10/20', 63, 1, 1, 'F', 1),
('2017/10/20', 64, 1, 1, 'F', 1),
('2017/10/20', 9, 4, 1, 'F', 1),
('2017/10/22', 30, 11, 2, 'F', 1),
('2017/10/24', 115, 17, 2, 'F', 1),
('2017/10/24', 116, 17, 2, 'F', 1),
('2017/10/25', 47, 16, 1, 'F', 1),
('2017/10/27', 122, 11, 2, 'F', 1),
('2017/10/28', 82, 2, 1, 'F', 1),
('2017/10/31', 57, 6, 1, 'F', 1),
('2017/10/31', 78, 4, 2, 'F', 1),
('2017/11/01', 103, 4, 2, 'F', 1),
('2017/11/01', 78, 2, 1, 'F', 1),
('2017/11/03', 36, 15, 1, 'F', 1),
('2017/11/07', 77, 7, 1, 'F', 1),
('2017/11/07', 76, 7, 1, 'F', 1),
('2017/11/08', 12, 4, 1, 'F', 1),
('2017/11/10', 42, 16, 1, 'F', 1),
('2017/11/10', 41, 16, 1, 'F', 1),
('2017/11/13', 19, 5, 2, 'F', 1),
('2017/11/13', 38, 15, 1, 'F', 1),
('2017/11/12', 38, 8, 2, 'F', 1),
('2017/11/20', 50, 5, 2, 'F', 1), 
('2017/11/22', 109, 11, 1, 'F', 1),
('2017/11/23', 39, 5, 1, 'F', 1),
('2017/11/23', 54, 5, 1, 'F', 1),
('2017/11/27', 7, 4, 2, 'F', 1),
('2017/11/28', 20, 2, 2, 'F', 1),
('2017/11/30', 121, 2, 1, 'F', 1),
('2017/11/30', 75, 7, 2, 'F', 1), 
('2017/12/02', 75, 17, 1, 'F', 1),
('2017/12/02', 126, 17, 2, 'F', 1),
('2017/12/04', 21, 14, 1, 'F', 1),
('2017/12/05', 19, 14, 1, 'F', 1),
('2017/12/06', 37, 15, 2, 'F', 1), 
('2017/12/06', 22, 14, 1, 'F', 1),
('2017/12/06', 23, 2, 2, 'F', 1), 
('2017/12/07', 23, 14, 1, 'F', 1),
('2017/12/07', 88, 8, 1, 'F', 1),
('2017/12/08', 25, 9, 2, 'F', 1),
('2017/12/09', 123, 18, 1, 'F', 1),
('2017/12/09', 124, 18, 1, 'F', 1),
('2017/12/09', 118, 2, 1, 'F', 1),
('2017/12/09', 122, 18, 1, 'F', 1),
('2017/12/11', 119, 2, 1, 'F', 1),
('2017/12/11', 120, 2, 1, 'F', 1),
('2017/12/11', 7, 2, 1, 'F', 1),
('2017/12/11', 51, 2, 1, 'F', 1),
('2017/12/12', 20, 4, 1, 'F', 1),
('2017/12/12', 37, 4, 1, 'F', 1),
('2017/12/12', 99, 4, 1, 'F', 1),
('2017/12/12', 15, 4, 2, 'F', 1),
('2017/12/18', 124, 14, 1, 'F', 1),
('2017/12/19', 50, 18, 1, 'F', 1),
('2017/12/19', 107, 18, 1, 'F', 1),
('2017/12/19', 132, 18, 1, 'F', 1),
('2017/12/21', 128, 9, 1, 'F', 1), 
('2017/12/22', 133, 9, 1, 'F', 1);

INSERT INTO transferencia_profissional (data_transacao, profissional_id, equipe_base_id, tipo, status, jogador_custom_id, cargo_id) VALUES
('2017/01/06' ,6, 16, 1, 'F' , 1, 2),
('2017/01/31' ,8, 17, 1, 'F' , 1, 2),
('2017/03/01' ,6, 16, 2, 'F' , 1, 2),
('2017/03/25' ,9, 5, 1, 'F' , 1, 2),
('2017/04/07' ,10, 7, 1, 'F' , 1, 2),
('2017/04/07' ,11, 7, 2, 'F' , 1, 2),
('2017/04/09' ,12, 2, 1, 'F' , 1, 2),
('2017/04/28' ,13, 4, 2, 'F' , 1, 2),
('2017/05/02' ,14, 7, 1, 'F' , 1, 2),
('2017/05/02' ,14, 6, 2, 'F' , 1, 2),
('2017/05/04' ,2, 1, 2, 'F' , 1, 2),
('2017/05/16' ,4, 6, 2, 'F' , 1, 2),
('2017/05/16' ,15, 6, 2, 'F' , 1, 2),
('2017/05/17' ,16, 1, 1, 'F' , 1, 2),
('2017/05/17' ,5, 1, 1, 'F' , 1, 2),
('2017/05/17' ,17, 1, 1, 'F' , 1, 2),
('2017/05/22' ,6, 8, 1, 'F' , 1, 2),
('2017/05/24' ,18, 16, 1, 'F' , 1, 2), 
('2017/06/01' ,19, 9, 1, 'F' , 1, 2),
('2017/06/28' ,8, 17, 2, 'F' , 1, 2),
('2017/08/03' ,20, 16, 1, 'F' , 1, 2),
('2017/08/08' ,9, 5, 2, 'F' , 1, 2),
('2017/08/27' ,12, 2, 2, 'F' , 1, 2),
('2017/09/06' ,22, 15, 2, 'F' , 1, 2),
('2017/09/09' ,10, 7, 2, 'F' , 1, 2),
('2017/09/11' ,23, 5, 2, 'F' , 1, 2),
('2017/09/11' ,23, 7, 1, 'F' , 1, 2),
('2017/10/05' ,4, 6, 2, 'F' , 1, 2),
('2017/11/04' ,24, 11, 1, 'F' , 1, 2),
('2017/11/18' ,1, 11, 1, 'F' , 1, 2),
('2017/11/21' ,2, 14, 1, 'F' , 1, 2),
('2017/12/03' ,27, 17, 1, 'F' , 1, 2),
('2017/12/09' ,25, 18, 1, 'F' , 1, 2),
('2017/12/11' ,26, 2, 1, 'F' , 1, 2),
('2017/12/11' ,12, 2, 1, 'F' , 1, 2);
